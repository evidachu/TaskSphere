...
<body>
        ...
        <div class="container d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                <h4 class="me-3 text-white">
                    <a href="/dashboard" class="text-white text-decoration-none">Dashboard Kolaborasi Web</a>
                </h4>
    ...
    <div class="modal fade" id="editmateriModal" tabindex="-1" aria-labelledby="editmateriModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('materi.update', ':id') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="modal-header">
    ...
    <script>
        function openEditModal(materiId) {
            ...
            fetch(`/materi/${materiId}/edit`)
                ...
                .then(data => {
                    document.querySelector('#editmateriModal form').action = `/materi/${materiId}`;
